...
RESTORE_FAILED = "Restoration failed: {detail}"
RESTORE_SOURCE_MISSING = "No source image to restore — pick a gallery image or upload one."
...
COMPARE_FAILED = "Compare sweep failed: {detail}"
COMPARE_PARAM_INVALID = "'{param}' can't be swept — choose steps, guidance scale, sampler or seed."
COMPARE_VALUES_REQUIRED = "Add at least one value for the '{param}' axis."
COMPARE_VALUE_INVALID = "One of the '{param}' values is out of range or invalid."
COMPARE_TOO_MANY_CELLS = "That's {count} images — keep the grid to {max} or fewer (reduce the axis values)."
LORA_NOT_FOUND = "Unknown LoRA: {slug}."
