...
import type { CompareAxis, CompareParam, PromptValue } from "@/types";
...
export const ComparePanel = () => {
  ...
  // Compare's grid is gated on the model list (loading / error / none downloaded).
  const gate =
  ...
  return (
    <JobPanelShell
      ...
      gate={gate}
      running={running}
      runIcon={<GridViewIcon />}
      runLabel={t("compare.run")}
      runningLabel={t("compare.running")}
      onRun={handleRun}
      runDisabled={!canRun}
      onClear={handleClear}
